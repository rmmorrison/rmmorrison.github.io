...
const Contact = () => {
    ...
    return (
        <div id="contact" className='my-24 w-full'>
            <div className="text-intellij-comments text-2xl mb-6">{'// contact'}</div>
            <span className="text-grey-light">Want to get in touch? Reach out to me via </span>
            <span className="text-intellij-orange"><Obfuscate email={email} /></span>
            <span className="text-grey-light"> for inquiries.</span>
            <div className="mt-9 credits text-intellij-white">
                ...
                <div className="text-grey-light">{`>>`} thanks for stopping by!</div>
                <Links />
            </div>
        </div>
    )
